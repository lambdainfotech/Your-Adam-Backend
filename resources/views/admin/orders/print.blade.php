...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .invoice-title { font-size: 22px; font-weight: 700; color: #111827; letter-spacing: 1px; }
        ...
        .info-block p { font-size: 12px; color: #111827; margin: 2px 0; }
        .info-block .name { font-weight: 600; color: #111827; font-size: 13px; margin-bottom: 3px; }
        ...
        .items-section { padding: 18px 32px; }
        .section-label {
        ...
        .items-table td { padding: 10px; vertical-align: middle; }
        ...
        .product-name { font-weight: 600; color: #111827; font-size: 12px; line-height: 1.3; }
        .product-sku { font-size: 10px; color: #9ca3af; margin-top: 2px; }
        .qty-pill {
            display: inline-block; padding: 2px 10px; background: #f3f4f6;
            border-radius: 10px; font-size: 11px; font-weight: 600; color: #374151;
        }

        .totals-section { padding: 16px 32px 20px; display: flex; justify-content: flex-end; }
        ...
        .total-row.grand {
            border-top: 1.5px solid #111827; margin-top: 8px; padding-top: 10px;
        }
        .total-row.grand .label { font-size: 13px; font-weight: 700; color: #111827; }
        .total-row.grand .value { font-size: 16px; font-weight: 700; color: #2563eb; }

        .invoice-footer {
            padding: 16px 32px; text-align: center;
            background: #f9fafb; border-top: 1px solid #e5e7eb;
        }
        .invoice-footer .thanks { font-size: 13px; font-weight: 600; color: #111827; margin-bottom: 3px; }
        .invoice-footer .small { font-size: 11px; color: #6b7280; }
    ...
    <div class="invoice-wrapper">
        ...
        <div class="invoice-header">
            <div class="brand-block">
                ...
                <div>
                    <div class="brand-name">{{ config('app.name', 'eCommerce API') }}</div>
        ...
        <div class="info-section">
            <div class="info-block">
                ...
                @if($addrLine2)<p class="small">{{ $addrLine2 }}</p>@endif
                    ...
                    <tr>
                        <td>
                            <div class="product-cell">
                                ...
                                @else
                                    <div class="product-icon-fallback"><i class="fas fa-box"></i></div>
                                @endif
                                <div>
        ...
        <div class="totals-section">
            <div class="totals-box">
                ...
                <div class="total-row discount">
                    <span class="label">
                        Discount
                        @if($order->coupon_code)<span style="font-size: 10px; color: #9ca3af;">({{ $order->coupon_code }})</span>@endif
                    </span>
                ...
                <div class="total-row">
                    <span class="label">
                        Shipping
                        @if($order->shipping_zone)<span style="font-size: 10px; color: #9ca3af;">({{ $order->shipping_zone === 'inside_dhaka' ? 'Inside Dhaka' : 'Outside Dhaka' }})</span>@endif
                    </span>
                    <span class="value">
