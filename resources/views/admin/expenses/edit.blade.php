...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <form action="{{ route('admin.expenses.update', $expense) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    @if($expense->receipt_image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $expense->receipt_image) }}" alt="Receipt" class="h-32 rounded-lg border">
                        </div>
                    @endif
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('notes', $expense->notes) }}</textarea>
