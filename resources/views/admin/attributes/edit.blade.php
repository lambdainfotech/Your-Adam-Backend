...
<div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        <div class="flex items-center mb-6">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-800">Edit Attribute</h2>
                <p class="text-gray-500">Update attribute details and values</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.attributes.update', $attribute->id) }}">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $attribute->code) }}" required
                        ...
                        placeholder="e.g., color, size, material" readonly>
                    <p class="mt-1 text-xs text-gray-500">Unique code cannot be changed</p>
                    @error('code')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                        <input type="checkbox" name="is_filterable" id="is_filterable" value="1" {{ old('is_filterable', $attribute->is_filterable) ? 'checked' : '' }}
                    ...
                    <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                        <input type="checkbox" name="is_variation" id="is_variation" value="1" {{ old('is_variation', $attribute->is_variation) ? 'checked' : '' }}
                            class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <div class="ml-3">
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $attribute->sort_order ?? 0) }}" min="0"
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mb-3">Manage values for this attribute</p>
            ...
            <div class="mt-8 flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    <button type="submit" name="action" value="save" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
