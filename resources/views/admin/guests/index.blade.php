...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-1">Manage guest checkout customers</p>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase">Registered</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($guests as $guest)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 text-gray-500">{{ $guest->id }}</td>
                            <td class="px-6 py-4">
