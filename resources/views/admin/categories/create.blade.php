                    ...
                    <div>
                        ...
                        <div id="heroDropZone" class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-indigo-400 hover:bg-indigo-50 transition-all cursor-pointer relative">
                            ...
                            <div id="heroDropZoneDefault">
                                ...
                                <p class="text-gray-600 text-sm mb-2">Upload Hero Banner Image</p>
                    ...
                    <div id="coverImageSection">
                        ...
                        <div id="coverDropZone" class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-rose-400 hover:bg-rose-50 transition-all cursor-pointer relative">
                            ...
                            <div id="coverDropZoneDefault">
                                ...
                                <p class="text-gray-600 text-sm mb-2">Upload Cover Image</p>
...
<script>
    ...
    function toggleCoverImageSection() {
        if (!parentSelect.value) {
            ...
            // Clear cover image input when hidden
