        ...
        <div class="md:col-span-1">
            <div class="bg-white rounded-lg shadow">
                ...
                <nav class="p-2">
                    ...
                    <a href="{{ route('admin.settings.terms') }}"
                        class="block px-4 py-2 rounded-lg hover:bg-gray-50 text-gray-700">
                        <i class="fas fa-file-contract w-6"></i> Terms & Conditions
                    </a>
                    <a href="{{ route('admin.settings.privacy') }}"
                        class="block px-4 py-2 rounded-lg hover:bg-gray-50 bg-blue-50 text-blue-600">
        ...
        <div class="md:col-span-2 space-y-6">
                ...
                <form action="{{ route('admin.settings.update') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="settings[privacy_page_title]"
                                value="{{ $settings['privacy_page_title'] ?? 'Privacy Policy' }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Subtitle</label>
                            <input type="text" name="settings[privacy_page_subtitle]"
                                value="{{ $settings['privacy_page_subtitle'] ?? '' }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Short Description</label>
                            <textarea name="settings[privacy_page_description]" rows="3"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ $settings['privacy_page_description'] ?? '' }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Hero Image URL</label>
                            <input type="text" name="settings[privacy_page_hero_image]"
                                value="{{ $settings['privacy_page_hero_image'] ?? '' }}"
                                placeholder="https://example.com/image.jpg or /storage/..."
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="settings[privacy_page_last_updated]"
                                value="{{ $settings['privacy_page_last_updated'] ?? now()->format('F d, Y') }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="settings[privacy_page_show_last_updated]" value="1"
                                    {{ ($settings['privacy_page_show_last_updated'] ?? '1') == '1' ? 'checked' : '' }}
                                    class="sr-only peer">
                                <div
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form action="{{ route('admin.settings.update') }}" method="POST" id="sectionsForm">
                            ...
                            <div class="section-row border border-gray-200 rounded-lg p-4">
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    <button type="button" onclick="removeSection(this)"
                                        class="text-red-600 hover:bg-red-50 px-2 py-1 rounded text-sm">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <input type="text" name="section_titles[]"
                                            value="{{ $section['title'] ?? '' }}"
                                    ...
                                    <div>
                                        ...
                                        <textarea name="section_contents[]" rows="6" placeholder="Write the section content here..."
                                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ $section['content'] ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @empty
                    ...
                    <div class="mt-4">
                        <button type="button" onclick="saveSections()"
                            class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Save Sections</button>
                    </div>
                </form>
            </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="settings[privacy_page_show_contact_cta]" value="1"
                                    {{ ($settings['privacy_page_show_contact_cta'] ?? '1') == '1' ? 'checked' : '' }}
                                    class="sr-only peer">
                                <div
                                    class="w-11 h-6 bg-gray-200 peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600">
                                </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="settings[privacy_page_contact_cta_text]"
                                value="{{ $settings['privacy_page_contact_cta_text'] ?? '' }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Button Text</label>
                            <input type="text" name="settings[privacy_page_contact_cta_button]"
                                value="{{ $settings['privacy_page_contact_cta_button'] ?? '' }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Button Link</label>
                            <input type="text" name="settings[privacy_page_contact_cta_link]"
                                value="{{ $settings['privacy_page_contact_cta_link'] ?? '' }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    <div class="mt-4">
                ...
                <form action="{{ route('admin.settings.update') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="settings[privacy_page_meta_title]"
                                value="{{ $settings['privacy_page_meta_title'] ?? '' }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Meta Description</label>
                            <textarea name="settings[privacy_page_meta_description]" rows="3"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ $settings['privacy_page_meta_description'] ?? '' }}</textarea>
                        </div>
                    </div>
                    <div class="mt-4">
                        <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Save
